...
---
## What is TENTROPY?
TENTROPY is a **Capture-The-Flag style learning platform** for AI/ML engineers who want to learn the **infrastructure and reliability patterns** that make LLM applications production-ready.
...
Build intuition for distributed systems failure modes:
...
- Distributed tracing to investigate failure in a microservice chain.
- Sliding window error rate calculation to trigger alerts.
- structured JSON logging to make debugging queryable.

*Other tracks and challenges are Coming Soon*
---
## Open Source Core
...
> **Want the full experience?** Visit [tentropy.dev](https://tentropy.co) for all challenges.
---
## Tech Stack
| Layer | Technology |
|-------|------------|
