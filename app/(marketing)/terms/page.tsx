    ...
    return (
        <div className="container mx-auto px-4 pt-8 pb-12 max-w-4xl text-gray-300 prose prose-invert prose-headings:text-white prose-a:text-hazard-amber">
            ...
            <section className="mb-8">
                ...
                <p>
                    These Terms of Service constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you") and TENTROPY, concerning your access to and use of the TENTROPY website and services.
            ...
            <section className="mb-8">
                ...
                <p className="mt-2">Specifically, you agree not to:</p>
                <ul className="list-disc pl-6 space-y-2">
