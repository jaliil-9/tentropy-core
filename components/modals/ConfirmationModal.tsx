            ...
            <div className="bg-deep-anthracite border border-hazard-amber rounded-sm w-full max-w-md p-6 shadow-[0_0_30px_rgba(255,176,0,0.1)] animate-in zoom-in-95 duration-200 relative">
                ...
                <div className="flex gap-3 relative z-10">
                    <button
                        onClick={onClose}
                        disabled={loading}
                        className="flex-1 bg-transparent hover:bg-tungsten-grey/20 text-gray-300 border border-tungsten-grey font-bold py-3 rounded-sm transition-all uppercase tracking-wider disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        {cancelText}
                    </button>
                    <button
                        ...
                        disabled={loading}
                        className="flex-1 bg-hazard-amber hover:bg-yellow-500 text-black font-bold py-3 rounded-sm transition-all uppercase tracking-wider hover:shadow-[0_0_15px_rgba(255,176,0,0.4)] disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                    >
